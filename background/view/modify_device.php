...
<div class="wrapper">
	...
	<div class="rightbox">
			...
			<?php
				include("connect.php");
				$sql="select d_name,d_pic_path,d_content,d_id from device where d_id=".$_GET['id'];
			...
			?>
			<form action="../model/modify_devcie.php" method="post" enctype="multipart/form-data">
			<table width="650px" align="center" >
				...
				<tr><td ></td>
					<td><input type="submit" onclick="return check();" value="修改设备信息"/></td>
				</tr>
			</table>
