...
?>	
	...
	<tr><td>
	    <a href="modify_activity.php?ac_id=<?php echo $activity[0]; ?>">编辑</a>|
		<a href="modify_activity_pic.php?id=<?php echo $activity[0]; ?>">编辑照片</a>|
		<a href="javascript:deleteactivity('<?php echo $activity[0]?>')">删除</a></td></tr>
<?php
	}
?>
	<tr>
